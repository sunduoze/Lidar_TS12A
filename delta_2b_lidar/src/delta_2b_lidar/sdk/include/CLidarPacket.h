...
#define LIDAR_DATA_START_LOC 11 //enzo add
	...
	namespace hwdrivers
	{
	    class CLidarPacket
	    {
	        public:
                ...
                /* Get params data ptr */
                u8* getParamPtr() {return isValid()? (&m_buf[LIDAR_DATA_START_LOC]): NULL; } //enzo modify u8* getParamPtr() {return isValid()? (&m_buf[8]): NULL; } 
                ...
                struct TParams
                {
                    TParams()
                    {
                        ...
                        //  1 +  2  +  1  +  1  +  1  +  0  +  0  +  2 = 8
                        least_packet_len = LIDAR_DATA_START_LOC;//enzo modify 8
                    }
